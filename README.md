# Unique Photo Filter
Camera filters are extremely popular. Millennials want to push the boundaries of uniqueness. As a photo filter becomes popular, it strays from it’s intended purpose - to create a truly unique and special picture.

I propose that Machine Learning (ML) can assist in creating a truly unique filter, tailored to the individual’s specific face. By analysing a person’s face, we can generate a filtering algorithm that is truly unique.
